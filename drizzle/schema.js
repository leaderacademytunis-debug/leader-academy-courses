...
exports.courses = (0, mysql_core_1.mysqlTable)('courses', {
    ...
    level: (0, mysql_core_1.mysqlEnum)('level', { enum: ['beginner', 'intermediate', 'advanced'] }),
...
exports.enrollments = (0, mysql_core_1.mysqlTable)('enrollments', {
    ...
    status: (0, mysql_core_1.mysqlEnum)('status', { enum: ['active', 'completed', 'dropped'] }).default('active'),
...
exports.assessments = (0, mysql_core_1.mysqlTable)('assessments', {
    ...
    title: (0, mysql_core_1.varchar)('title', { length: 255 }).notNull(),
    description: (0, mysql_core_1.text)('description'),
    type: (0, mysql_core_1.mysqlEnum)('type', { enum: ['quiz', 'assignment', 'exam'] }),
...
exports.assessmentQuestions = (0, mysql_core_1.mysqlTable)('assessment_questions', {
    ...
    type: (0, mysql_core_1.mysqlEnum)('type', { enum: ['multiple_choice', 'short_answer', 'essay'] }),
